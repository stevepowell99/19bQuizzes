...
Write long, unique factor labels for each individual statement to capture every nuance
...
y Nest factors so you can zoom in and out to control the level of detail shown
Mark "negative" factors so they are treated as the opposite of their positive counterpart
y Group causal factors so that individual factors are sub-aspects of a higher-level factor
